...
import com.example.vuthyra.xyzreader.data.ArticleLoader.Query;
import com.example.vuthyra.xyzreader.data.ItemsContract;
import com.example.vuthyra.xyzreader.data.UpdaterService;
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            if (!publishedDate.before(START_OF_EPOCH.getTime())) {
                ...
                holder.subtitleView.setText(getString(R.string.byline_placeholder_linebreak,
                        mOutputFormat.format(publishedDate),
                        mCursor.getString(ArticleLoader.Query.AUTHOR)));

            }

            Picasso.get().load(mCursor.getString(Query.PHOTO_URL)).into(holder.thumbnailView);
